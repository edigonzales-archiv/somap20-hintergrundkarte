...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="kantonsnam">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="kantonskue">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <renderer-v2 forceraster="0" preprocessing="0" type="invertedPolygonRenderer" enableorderby="0">
    <renderer-v2 forceraster="0" symbollevels="0" type="RuleRenderer" enableorderby="0">
      <rules key="{e826f8b2-1fb4-42b0-a716-6f907f6da190}">
        <rule scalemaxdenom="1000000" key="{1787a3ad-3088-4887-923d-22aa77cd77de}" symbol="0" scalemindenom="50000"/>
  ...
  <aliases>
    ...
    <alias field="kantonsnam" index="2" name=""/>
    <alias field="kantonskue" index="3" name=""/>
    <alias field="kantonsnum" index="4" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="kantonsnam"/>
      <column width="-1" hidden="0" type="field" name="kantonskue"/>
      <column width="-1" hidden="0" type="field" name="kantonsnum"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="kantonsnam" expression=""/>
    <default field="kantonskue" expression=""/>
    <default field="kantonsnum" expression=""/>
  </defaults>
